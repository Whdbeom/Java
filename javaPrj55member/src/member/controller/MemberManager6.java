...
public class MemberManager6 {

	private Scanner sc = new Scanner(System.in);
	private String x = File.separator;
	private File f = new File("C:" + x + "Users" + x + "종범" + x + "Desktop" + x + "mm6.txt");
	...
	public void showMenu() throws Exception {
		...
		default : System.out.println("잘못입력햇어용");
		}
	}
